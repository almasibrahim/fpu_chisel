...
class ALU_api_t: public sim_api_t<VerilatorDataWrapper*> {
    ...
    void init_sim_data() {
        ...
        sim_data.inputs.push_back(new VerilatorCData(&(dut->io_f5)));
...
int main(int argc, char **argv, char **env) {
    ...
    VALU* top = new VALU;
    std::string vcdfile = "test_run_dir/ALU_Test/ALU.vcd";
    ...
    Verilated::mkdir("test_run_dir/ALU_Test/logs");
    VerilatedCov::write("test_run_dir/ALU_Test/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
