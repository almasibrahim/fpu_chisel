...
#endif
#include <iostream>
class mul_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    mul_api_t(Vmul* _dut) {
        dut = _dut;
        main_time = 0L;
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["mul.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    Vmul* top = new Vmul;
    std::string vcdfile = "test_run_dir/mul_Test/mul.vcd";
    ...
    Verilated::mkdir("test_run_dir/mul_Test/logs");
    VerilatedCov::write("test_run_dir/mul_Test/logs/coverage.dat");
#endif
    delete top;
    exit(0);
}
